...
class CreditRepositoryTest {
    ...
    fun `should find credit by credit code`() {
        //given
        val creditCode1: UUID = UUID.fromString("e27d0b5b-ce75-4090-9d9d-f61146155905")
        val creditCode2: UUID = UUID.fromString("042d5c8c-1945-49bc-95f8-5732842058da")
    ...
    private fun buildCredit(
        ...
        dayFirstInstallment: LocalDate = LocalDate.of(2024, Month.AUGUST, 22),
